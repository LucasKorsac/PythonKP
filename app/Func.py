# Генерация простых чисел след. способами: случайным поиском с тестом Миллера-Рабина, сильные простые числа.
...
class Generator:
    ...
    def MillerRabin(n, k=40):
        ...
        for _ in range(k):
            a = random.randrange(
                2, n - 2
            )  # Выбор случайного числа из диапазона [2, n-2]
    ...
    def GenPr(bit):
        ...
        while True:
            ...
            number |= (
                1 << (bit - 1)
            ) | 1  # Гарантия что число является  нечетным и битным
